...
describe("OLX.ba Search - Special characters", function () {
  this.timeout(30000);

  it("Should handle search with special characters without crashing", async function () {
    ...
    assert.ok(
      ...
      "Application crashed or navigated away on special character search"
    );
  });
});
