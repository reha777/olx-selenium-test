...
describe("OLX.ba Search - Leading spaces", function () {
  this.timeout(30000);

  it("Should handle search with leading spaces", async function () {
    ...
    assert.ok(
      ...
      "Application crashed or navigated away on leading spaces search"
    );
  });
});
